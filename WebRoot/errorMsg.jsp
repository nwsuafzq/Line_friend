	    ...
	    <div id="mymessage">
			  ...
			  <div class="mymessage" id="AllOrders">
					<div style="width:461px; float:left;">
                        <img src="assets/homeImages/error.jpg"  height="300px"/>
                    </div>
                    
                    <div style="float:right; width:420px; height:300px; padding-top:100px;">
                    <span style="font-size:24px;">抱歉, ${errorMsg }</span><br />
                    <span style="font-size:20px;">您可以<a href="home.jsp" style="color:red;">点击此处</a>返回首页</span>
                    </div>	
